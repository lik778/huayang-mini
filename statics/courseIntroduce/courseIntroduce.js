...
Page({
  ...
  run() {
    ...
    queryTravelList({
      ...
      this.setData({
        travelList: this.handleTravelData(data)
      });
    });
  ...
  goToPureWebview(e) {
    ...
    bxPoint("university_activity_list_click", {
      activity_id: item.id
    }, false)
  ...
  onAdsItemTap(e) {
    ...
    if (item) {
      bxPoint("university_course_enroll_click", {
        course_id: item.id,
  ...
  onTravelItemTap(e) {
    ...
    bxPoint("university_travel_click", {
      edu_travel_id: id,
      edu_travel_name: name,
      edu_travel_title: title
    }, false)
    wx.navigateToMiniProgram({
  ...
  toVideoCourseDetail(e) {
    ...
    bxPoint("university_series_list_click", {
      series_id: item.id
    }, false)
    wx.navigateTo({
  ...
  goToMorePage(e) {
    ...
    switch (type) {
      case "live": {
        ...
        wx.navigateTo({
          url: "/pages/channelLive/channelLive"
        })
        break
      }
      case "public": {
        ...
        wx.navigateTo({
          url: "/statics/publicActivities/publicActivities"
        })
        break
      }
      case "offline": {
        ...
        wx.navigateTo({
          url: "/pages/shopSubject/shopSubject"
        })
        break
      }
      case "travel": {

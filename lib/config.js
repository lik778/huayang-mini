...
export const GLOBAL_KEY = {
  ...
  practiceGuideExpiredAt: "hy_practice_guide_expired_at", // 学习课程提醒引导过期时间
}
...
export const ROOT_URL = {
  dev: 'https://dev.huayangbaixing.com',
...
export const URL = {
  /* 师资版本 */
  getTeacherNewInfo: "/hy/infocard/tutor/info/c/detail", //获取老师信息详情
  getTeacherNewHonorList: "/hy/infocard/tutor/honor/list", //获取老师荣誉列表
  getTeacherNewMomentList: "/hy/infocard/tutor/dynamic/list", //获取导师动态列表
  getTeacherNewMomentDetail: "/hy/infocard/tutor/dynamic/detail", //获取导师动态详情
  deleteTeacherNewMoment: "/hy/infocard/tutor/dynamic/delete", //获取老师动态详情
  getTeacherNewCommentList: "/hy/infocard/tutor/comment/c/list", //获取老师留言列表
  publishTeacherNewComment: "/hy/infocard/tutor/comment/save", //发布老师留言
  deleteTeacherNewComment: "/hy/infocard/tutor/comment/delete", //删除老师留言
  publishTeacherNewMoment: "/hy/infocard/tutor/dynamic/save", //发布动态
  createQrcode: "/hy/wx/applets/unlimit/qrcode", //生成小程序码
  likeTeacherNew: '/hy/infocard/tutor/info/like', //点赞老师
  likeTeacherNewComment: "/hy/infocard/tutor/comment/like/change", //点赞评论
  getTeacherNewTeacherList: "/hy/infocard/tutor/info/c/list", //获取老师列表
  getTeacherNewMedalList: '/hy/infocard/tutor/medal/for/tutor', //获取老师勋章列表
  /* 花样生活 */
  queryWaterfallList: "/hy/goodlife/hylife/media/c/list", //获取花样生活瀑布流列表
  queryWaterfallDetailInfo: "/hy/goodlife/hylife/media/detail", //获取花样生活瀑布流详情信息
  recordWaterfallVisitCount: '/hy/goodlife/hylife/media/view/count', //记录花样生活瀑布流浏览量
  ...
  getRecentTravelList: "/hy/travel/product/group/totravel/list", // 获取近期团期列表
  ...
  lifeStatusAndJobList: "/hy/tool/enum/list", //获取生活状态&职业列表
  ...
  checkNeedToFillInfo: "/hy/user/info/userHasAddr",
  ...
  /* 畅学卡 */
  queryFlunetLearnInfo: "/hy/zhide/card/fluentLearn/info", // 查询畅学卡权益
  queryFluentCardHotkecheng: "/hy/zhide/card/fluentLearn/recommend/kecheng", // 查询畅学卡热门课程
  queryFluentCardNewkecheng: "/hy/zhide/card/fluentLearn/new/kecheng", // 查询畅学卡最新课程
  payFluentCard: "/hy/zhide/card/fluentLearn/pay", // 畅学卡下单
  queryFluentCardInfo: "/hy/zhide/user/card/fluentLearn", // 查询用户畅学卡信息
  queryFluentQrCode: "/hy/zhide/card/fluentLearn/share/qrcode", // 获取畅学卡分销二维码
  queryDistributeRecordList: "/hy/account/record/list", // 获取用户余额记录
  acceptKechengWithFluentCard: "/hy/zhide/card/fluentLearn/kecheng/join", // 畅学卡会员免费领取视频课程
  queryFluentDistributeGuide: "/hy/zhide/card/fluentLearn/guid/link", // 获取畅学卡引导私域配置信息
  ...
  queryFluentCardChannelInfo: "/hy/user/channel/cfg", // 获得畅学卡渠道信息
  // cps
  douyinWxPay: "/hy/temp/cps/page/pay", //抖音cps落地页下单获取orderId
  queryDiscoveryRemindData: "/hy/zhide/user/remind/get", // 请求首页弹窗任务

  /*****************校友动态************* */
  getBarrageList: '/hy/zhide/barrage/list', //C端用户获取弹幕列表
  createBarrage: '/hy/zhide/barrage/create', //C端创建获取弹幕
  getStudentCommentList: "/hy/zhide/bubble/list", //C端获取校友动态列表
  likeMoment: "/hy/zhide/bubble/like", //点赞动态
  unLikeMoment: "/hy/zhide/bubble/unlike", //点赞动态
  getCommentList: "/hy/zhide/bubble/comment/list", //C端获取校友动态评论列表
  publishComment: "/hy/zhide/bubble/comment", // C端发布校友动态评论
  getStudentMomentDetail: "/hy/zhide/bubble/detail", //获取校友动态详情
  ...
  queryStudentInfoByUserId: "/hy/user/info/getStudentInfoByUserId", // 通过用户ID，查询student信息
  queryUserJoinedActivitiesByMobile: "/hy/activity/user/join/list", // 根据手机号查询用户报名的活动
  queryUserPersonPageInfo: "/hy/infocard/tutor/info/person/page", // 个人中心获取师资信息

  /*线上免费课*/
  queryFreeOnlineCourse: "/hy/kecheng/onlineFree/getAllCourses",
  checkUserHasAddress: "/hy/user/info/userHasAddr", //判断用户是否已经填写地址

  setSubscribeMessage: "/hy/zhide/user/applets/message/subscribe", // 小程序消息通知订阅

  /* 花样画册 */
  bookServiceResourceUpload: "/hy/magazine/pic/upload", // 画册服务图片上传
  queryMagazineTemplate: "/hy/magazine/template/list", // 获取画册模版
  newMagazineOrder: "/hy/magazine/order", // 创建画册订单
  queryUserMagazineList: "/hy/magazine/user/list", // 获取用户画册订单列表

  // 代理商用户绑定
  agentUserBind: "/hy/agent/user/bind",

  // 花样相册
  queryPersonAlbumDetail: "/hy/album/collection/media/list",
  queryPersonAlbumMessage: "/hy/album/collection/detail",
  queryAlbumDetail: "/hy/album/detail",

  /* 首页改版 */
  queryHomeIcons: '/hy/goodlife/home/board/c/list', // 获取icon展示列表（c端）
  queryHomeHeadLines: '/hy/goodlife/home/headline/info', // 获取首页icon上新信息
	queryNewHeadLines: '/api/huayang-backend/customer/homeConfig/toutiao/list', // 获取首页头条配置
  queryYouZanKeCheng: '/hy/kecheng/youzan/list', // 获取有赞同步的培训课

  // 大赛专题页
  queryCompetitionMedia: "/hy/zhide/dasai/new/report/list", // 获取新闻报道列表
  queryCompetitionVideo: "/hy/zhide/dasai/video/list", // 获取精彩视频列表
  queryHistoryAlbums: "/hy/zhide/dasai/album/history", // 获取大赛历史相册
  queryHistoryAlbumsById: "/hy/album/list/by/ids", // 根据ID获取多个相册

  /*************生活馆**************/
  queryGoodLifeProducts: "/hy/goodlife/product/show/list", // 获取生活馆商品列表
  queryYouZanHomeLink: "/hy/goodlife/home/menu/address", // 获取有赞首页小程序地址

  /* 视频号直播预约 */
  queryChannelLives: "/hy/datahouse/live/review/list", // 获取视频号直播列表
  queryHomeChannelLive: "/hy/datahouse/live/review/home/show", // 获取直播预告首页显示
  queryCurrentTimeChannelLive: "/hy/datahouse/live/review/cover", // 获取当前时间的视频号直播数据
  queryHistorySubscribeChannelLives: "/hy/datahouse/live/subscribe/user/once/list", // 获取用户预约的单场视频号直播间
  subscribeMiniMessage: "/hy/datahouse/live/subscribe/save", // 用户订阅视频号直播
  getUserAttentionOfficeAccount:"/hy/user/isSubscribeGongZhongHao",//判断用户是否关注公众号

  /* 新年flag */
  saveNewYearFlagIn2020: "/hy/goodlife/fission/newyearflag/save", // 保存新年flag
  queryNewYearFlagListIn2020: "/hy/goodlife/fission/newyearflag/list", // 获取新年flag列表

  /* 新版老年大学首页 */
  queryTeacherList: "/hy/infocard/tutor/recommend/c/list", // 获取导师信息列表
  getOfflineCourseListOfIndex: "/hy/zhide/card/fluentLearn/kechengCfg/c/list",
  getOfflineCourseDetailOfIndex: "/hy/zhide/card/fluentLearn/kechengCfg/get",

	/* 正念练习 */
	queryMindfulnessList: "/api/huayang-backend/customer/mindfulness/listMindfulnessAudio",
	queryMindfulnessDetail: "/api/huayang-backend/customer/mindfulness/mindfulnessAudio/detail",
	checkMindfulness: "/api/huayang-backend/customer/mindfulness/checkin",
	queryMindfulnessStatistics: "/api/huayang-backend/customer/mindfulness/checkin/stat",
	queryMindfulnessCalendar: "/api/huayang-backend/customer/mindfulness/checkin/listByTimeRange",
  queryTravelList: "/hy/travel/product/list", // 获取游学产品列表
  
  /* 邀请码 */
  queryInvationNumber: "/api/huayang-backend/customer/userInvite/getInvitationCode",
  queryInvationList: "/api/huayang-backend/customer/userInvite/inviteUserList",
  queryInvationSet: "/api/huayang-backend/customer/userInvite/invite",
  queryAlreadyNumber: "/api/huayang-backend/customer/userInvite/invitedInfo"
}

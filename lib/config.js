...
export const URL = {
	...
	collectError: "/hy/frontend/error/data", // 错误捕获接口
	...
	queryUserPracticeRecentRecord: "/hy/user/study/list", // 查询用户最近练习记录
	...
	getVideoCourseListByBuyTag: "/hy/kecheng/series/with/buytag/list", // 获取视频系列课程列表(带已购标签)
	...
	getVideoCourseList: "/hy/kecheng/series/list", // 获取视频课程列表
	getVideoCourseDetail: "/hy/kecheng/series/detail", // 获取视频课程详情
	...
	getVideoPracticeData: "/hy/kecheng/series/joined/list", //练习页获取视频练习列表
	...
	// 获取学员信息
	checkNeedToFillInfo: "/hy/zhide/student/profile/update/check", //获取学员信息
	// 训练营打卡

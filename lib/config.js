...
export const URL = {
	...
	/* 首页改版 */
	getNewActivityList: '/hy/activity/board/list', //获取最新活动列表
	getGoodMorningBgTemplate: "/hy/zw/playbill/template/list", //获取早上好背景模版
	getIndexHeaderVideoList: "/hy/zhide/activity/headvideo/list", //获取首页头部视频列表
	getGoodLifeProducts: "/hy/goodlife/product/board/list", // 获取品质生活商品

...
export const URL = {
	...
	getInviteList:"/hy/invite/history",//获取用户邀请列表
	// 直播课程模块
	getCourseTypeList:"/hy/zhide/kecheng/category",//获取课程分类列表
	getCourseList:"/hy/zhide/kecheng/list",//获取课程列表
	getWatchLiveNum:"/hy/zhide/zhibo/permission/check",//统计直播观看人次
	getWatchLiveAuth:"/hy/zhide/zhibo/permission/check",//获取观看直播权限
	subscription:"/hy/zhide/user/subscribe",//订阅课程
	uploadFormId:"/hy/wx/applets/formId",//上传formID
	getSubscriptionStatus:"/hy/zhide/user/subscribe"//获取订阅状态
}
